# Render pipeline — wine GC-MS PLS-DA video -> final.mp4
...
PAGES_TIMINGS = [{"i": 1, "dur": 21}, {"i": 2, "dur": 25}, {"i": 3, "dur": 21}, {"i": 4, "dur": 23}, {"i": 5, "dur": 22}, {"i": 6, "dur": 26}, {"i": 7, "dur": 27}, {"i": 8, "dur": 22}, {"i": 9, "dur": 28}, {"i": 10, "dur": 20}, {"i": 11, "dur": 26}, {"i": 12, "dur": 10}, {"i": 13, "dur": 16}]
def node_env():
...
def mux():
    ...
    print("  ok",FINAL)
try:
    print("=== wine PLS-DA render ==="); audio(); rec(); mux(); print(f"=== DONE: {FINAL} ===")
